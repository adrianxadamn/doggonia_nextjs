...
const InlineCart = ({props}) => {
  ...
  return (
    <CSSTransition in={showCart} timeout={300} unmountOnExit classNames={{
      'enter': classes.inlineCartEnter,
      'enterActive': classes.inlineCartEnterActive,
      'enterDone': classes.inlineCartEnterDone,
      'exit': classes.inlineCartExit,
    }}>
